              ...
              <div className="inner">
                ...
                <div className="card-description">
                  ...
                  <p className="discription">
                    ...
                    aliquam sodales. Phasellus sed mauris hendrerit, laoreet sem
                    in, lobortis mauris hendrerit ante. Ut tincidunt est ac
                ...
                <div className="col-lg-4 col-md-6 col-12">
                  <div className="single-demo">
                    <div className="inner badge-1">
                      ...
                      <div className="inner">
                        <h3 className="title">
                          <a href="fashion-designer.html">Fashion Designer</a>
                        </h3>
                      </div>
                    </div>
                  </div>
                ...
                <div className="col-lg-4 col-md-6 col-12">
                  <div className="single-demo">
                    <div className="inner badge-1">
                      ...
                      <div className="inner">
                        <h3 className="title">
                          <a href="home-web-Developer.html">Web Developer</a>
                        </h3>
                      </div>
                    </div>
                  </div>
                ...
                <div className="col-lg-4 col-md-6 col-12">
                  <div className="single-demo">
                    <div className="inner">
                      ...
                      <div className="inner">
                        <h3 className="title">
                          <a href="home-content-writer.html">Content Writter</a>
                        </h3>
                      </div>
                    </div>
                  </div>
